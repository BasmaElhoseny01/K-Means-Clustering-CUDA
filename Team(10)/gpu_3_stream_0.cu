...
int main(int argc, char *argv[])
{
    ...
    std::string output_path = input_path.substr(0, input_path.find_last_of('.')) + "_output_gpu_3_stream_0.png";
...
// D:\Parallel-Computing-Project>nvprof -o ./profiles/out_gpu_3_stream_0.nvprof ./out_gpu_3_stream_0 ./tests/image_3.png 5
