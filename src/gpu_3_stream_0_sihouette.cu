...
int main(int argc, char *argv[])
{
    ...
    float *shilloute_scores = (float *)malloc(N * sizeof(float)); // Array to silhuotte Scores
...
// D:\Parallel-Computing-Project>nvprof -o ./profiles/out_gpu_3_stream_0_sihouette.nvprof ./out_gpu_3_stream_0_sihouette ./tests/image_3.png 5
